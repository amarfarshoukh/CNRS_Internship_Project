...
# =============================
LEBANON_LOCATIONS = {
    "بيروت": ["الحمرا","المزرعة","عين المريسة","الكرنتينا","الضبية","القصير","الجميزة",
              "الورشة","الرميلة","الشتوير","الضاحية الجنوبية","الطريق الجديدة","الحدث",
              "البدام","الرميلة الشرقية","الرميلة الغربية","الشياح","المنطقة الصناعية","الميناء"],
    "طرابلس": ["الميناء","الجامع الكبير","باب التبانة","الأنصار","البرج","الزاهرية","الحمرا",
               "المنكوبين","عين المريسة","الزيتونة"],
    "صيدا": ["المدينة القديمة","الزهور","المصنع","الجنوب","عين الريح","الرميلة","الزهراني"],
    "صور": ["المدينة القديمة","الصيادين","الجنوب","الزهراني","الرميلة","الجديدة"],
    "زحلة": ["القصير","الجنوب","البازورية","الحوش","المدينة","الناعمة","الرياق"],
    "بعلبك": ["المدينة","القصير","الجنوب","الريحان","حوش الابيض","عين الحجل","مزرعة يشوع"],
    "النبطية": ["المدينة","حاروف","مرجعيون","حاصبيا","حومين الغربي","حومين الشرقي",
                "كفررمان","عين بعال","مجدل سلم","الحدت","الزهراني","البرج","عبس"],
    "الشوف": ["دير القمر","فتوح","بحمدون","عبدا","معاصر الشوف","المصيطبة","جعيتا"],
    "جبيل": ["جبيل القديمة","الذوق","كفرحبّاب","كفرفالوس","الرويس","المزرعة"],
    "كسروان": ["جونيه","الدكوانة","الناعمة","عين الرمانة","حريصا","الرميلة","شويفات"]
}
