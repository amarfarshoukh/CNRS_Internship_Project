...
class IncidentKeywords:
    def __init__(self):
        self.incident_keywords = {
            ...
            'natural_disaster': ['زلزال', 'هزة', 'أرضية', 'هزة أرضية', 'فيضان', 'فيضانات', 'سيول', 'سيول جارفة', 'انهيار', 'انهيار أرضي', 'انهيارات أرضية', 'عاصفة', 'عواصف', 'عاصفة رعدية', 'عاصفة ثلجية', 'عاصفة مطرية', 'عواصف رعدية', 'عواصف ترابية', 'أمطار غزيرة', 'رياح قوية', 'إعصار', 'أعاصير', 'تسونامي', 'طوفان', 'حرائق غابات', 'جفاف', 'انزلاق تربة', 'سقوط صخور'],
