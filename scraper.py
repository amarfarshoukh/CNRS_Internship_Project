...
class IncidentKeywords:
    def __init__(self):
        self.incident_keywords = {
            ...
            'protest': ['خطوات تصعيدية','احتجاج', 'احتجاجات', 'مظاهرة', 'مظاهرات', 'تظاهرة', 'تظاهرات', 'اعتصام', 'اعتصامات', 'مسيرة احتجاجية', 'مسيرات احتجاجية', 'مسيرة', 'مسيرات', 'تجمع احتجاجي', 'تجمعات احتجاجية', 'وقف احتجاجي', 'وقفات احتجاجية', 'إضراب', 'إضرابات', 'تجمهر'],
            ...
            'airstrike': ['استهداف','الأسلحة الرشاشة','مسيرة', 'طيران', 'حربي', 'طيران حربي', 'غارة', 'غارة جوية', 'قصف', 'قصف جوي', 'قصف صاروخي', 'قصف مدفعي', 'صاروخ', 'صواريخ', 'قنبلة', 'قنابل', 'طائرة', 'طائرات', 'مقاتلة', 'مقاتلات', 'قصف بالطائرات', 'ضربة جوية', 'هجوم جوي', 'تفجير جوي', 'غارة جوية إسرائيلية', 'غارة إسرائيلية', 'سلاح الجو', 'ضربة صاروخية', 'هجوم صاروخي', 'قذيفة', 'قذائف'],
            ...
            'medical': ['دماء','دم','إسعاف', 'اسعاف', 'مستشفى', 'مستشفيات', 'طوارئ', 'قسم الطوارئ', 'إنعاش', 'انعاش', 'سيارة إسعاف', 'سيارات إسعاف', 'خدمة طبية', 'خدمات طبية', 'إصابة طبية', 'إصابات طبية', 'فريق طبي', 'طبيب', 'أطباء', 'ممرض', 'ممرضة', 'طاقم طبي', 'علاج', 'رعاية طبية', 'حالة صحية', 'حالات حرجة', 'مصاب', 'مصابين', 'نقل طبي', 'إخلاء طبي', 'إسعافات أولية'],
